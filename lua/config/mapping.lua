...
M.keys = {
  common = {
    ...
    mk_map("n", "<leader>mvh", "<cmd>RenderMarkdown buf_toggle<cr>", "Toggle markdown render (buffer)", "render-markdown"),
    mk_map("n", "<leader>mvs", "<cmd>RenderMarkdown preview<cr>", "Toggle markdown split preview", "render-markdown"),
    mk_map("n", "<leader>mvt", "<cmd>RenderMarkdown toggle<cr>", "Toggle markdown render", "render-markdown"),
